...
console.log('Legacy ES5 function'); // normal function
function add (a, b){
    return a + b;
}
...
console.log('New ES6 arrow functions'); // arrow function
const subtract = (a,b) => {
    return a - b;
}
...
const foutTimesFive = multiply(4,5);
console.log(foutTimesFive);
...
console.log('(' + numberArray1.length + ') [' + numberArray1 + ']');
console.log('(' + stringArray1.length + ') [' + stringArray1 + ']');
console.log('(' + variableArray1.length + ') [' +
                    variableArray1[0] +
                    ', ' + variableArray1[1] +
                    ', ' + variableArray1[2] +
                    ', Array(' + variableArray1[3].length + ')' +
                    ', Array(' + variableArray1[4].length + ')');
...
const init = () => {
    ...
    setClassAttr.attr('class', 'class-0'); /*set class*/
    ...
    hideBtn.click(hideHandle);
    showBtn.click(showHandle);
